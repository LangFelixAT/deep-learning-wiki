...
## Open questions
- Needs verification: later variants such as multi-query attention, grouped-query attention, and multi-head latent attention should be grounded in separate source notes.
