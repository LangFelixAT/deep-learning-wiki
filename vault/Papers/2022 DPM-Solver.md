...
$$
\lambda_t = \log\left(\frac{\alpha_t}{\sigma_t}\right)
$$
Source-level solution idea:

$$
x_t = \frac{\alpha_t}{\alpha_s} x_s - \alpha_t \int_{\lambda_s}^{\lambda_t} \exp(-\lambda) \epsilon_{\theta}(x_\lambda, \lambda) d \lambda
$$
